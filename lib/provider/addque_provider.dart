...
class AddQuestionProvider with ChangeNotifier{
  ...
  Future<Map<String, dynamic>> AddQuestion(dynamic adData) async {
    ...
    try{
      print("try");
      final response = await HttpClient.instance.postData(APIPathHelper.getValue(APIPath.add_question), adData,token);
